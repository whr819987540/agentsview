 ...
 */
import type { GetApiV1AnalyticsSignalsAutomatedScope } from "./getApiV1AnalyticsSignalsAutomatedScope.ts";

export type GetApiV1AnalyticsSignalsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsSignalsAutomatedScope;
  /**
