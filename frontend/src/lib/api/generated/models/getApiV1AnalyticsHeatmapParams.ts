 ...
 */
import type { GetApiV1AnalyticsHeatmapAutomatedScope } from "./getApiV1AnalyticsHeatmapAutomatedScope.ts";
import type { GetApiV1AnalyticsHeatmapMetric } from "./getApiV1AnalyticsHeatmapMetric.ts";

export type GetApiV1AnalyticsHeatmapParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsHeatmapAutomatedScope;
  /**
   ...
   * Heatmap metric
   */
  metric?: GetApiV1AnalyticsHeatmapMetric;
};
