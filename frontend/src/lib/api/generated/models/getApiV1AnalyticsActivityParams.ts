 ...
 */
import type { GetApiV1AnalyticsActivityAutomatedScope } from "./getApiV1AnalyticsActivityAutomatedScope.ts";
import type { GetApiV1AnalyticsActivityGranularity } from "./getApiV1AnalyticsActivityGranularity.ts";

export type GetApiV1AnalyticsActivityParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsActivityAutomatedScope;
  /**
   ...
   */
  granularity?: GetApiV1AnalyticsActivityGranularity;
};
