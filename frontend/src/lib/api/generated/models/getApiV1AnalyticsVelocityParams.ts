 ...
 */
import type { GetApiV1AnalyticsVelocityAutomatedScope } from "./getApiV1AnalyticsVelocityAutomatedScope.ts";

export type GetApiV1AnalyticsVelocityParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsVelocityAutomatedScope;
  /**
