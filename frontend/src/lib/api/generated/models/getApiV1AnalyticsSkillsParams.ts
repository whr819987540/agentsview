 ...
 */
import type { GetApiV1AnalyticsSkillsAutomatedScope } from "./getApiV1AnalyticsSkillsAutomatedScope.ts";
import type { GetApiV1AnalyticsSkillsGranularity } from "./getApiV1AnalyticsSkillsGranularity.ts";

export type GetApiV1AnalyticsSkillsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsSkillsAutomatedScope;
  /**
   ...
   */
  granularity?: GetApiV1AnalyticsSkillsGranularity;
};
