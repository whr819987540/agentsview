 ...
 */
import type { GetApiV1AnalyticsHourOfWeekAutomatedScope } from "./getApiV1AnalyticsHourOfWeekAutomatedScope.ts";

export type GetApiV1AnalyticsHourOfWeekParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsHourOfWeekAutomatedScope;
  /**
