 ...
 */
import type { GetApiV1AnalyticsProjectsAutomatedScope } from "./getApiV1AnalyticsProjectsAutomatedScope.ts";

export type GetApiV1AnalyticsProjectsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsProjectsAutomatedScope;
  /**
