 ...
 */
import type { GetApiV1AnalyticsToolsAutomatedScope } from "./getApiV1AnalyticsToolsAutomatedScope.ts";

export type GetApiV1AnalyticsToolsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsToolsAutomatedScope;
  /**
