 ...
 */
import type { GetApiV1TrendsTermsAutomatedScope } from "./getApiV1TrendsTermsAutomatedScope.ts";
import type { GetApiV1TrendsTermsGranularity } from "./getApiV1TrendsTermsGranularity.ts";

export type GetApiV1TrendsTermsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1TrendsTermsAutomatedScope;
  /**
   ...
   */
  granularity?: GetApiV1TrendsTermsGranularity;
};
