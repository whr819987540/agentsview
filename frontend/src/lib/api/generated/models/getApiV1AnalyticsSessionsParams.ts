 ...
 */
import type { GetApiV1AnalyticsSessionsAutomatedScope } from "./getApiV1AnalyticsSessionsAutomatedScope.ts";

export type GetApiV1AnalyticsSessionsParams = {
  /**
   * Range start date
   */
  from?: string;
   ...
   * Automation scope
   */
  automated_scope?: GetApiV1AnalyticsSessionsAutomatedScope;
  /**
