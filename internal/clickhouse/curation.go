...
func (s *Store) StarSession(_ context.Context, sessionID string) (bool, error) {
	return false, db.ErrReadOnly
}

func (s *Store) UnstarSession(_ context.Context, sessionID string) error {
...
func (s *Store) BulkStarSessions(_ context.Context, sessionIDs []string) error {
	return db.ErrReadOnly
}

func (s *Store) PinMessage(_ context.Context, sessionID string, messageID int64, note *string) (int64, error) {
	return 0, db.ErrReadOnly
}

func (s *Store) UnpinMessage(_ context.Context, sessionID string, messageID int64) error {
	return db.ErrReadOnly
}
